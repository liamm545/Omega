SECTOR_REGISTRY = {
    ...
    "바이오": {
        "stock_sectors": ["바이오", "제약", "헬스케어"],
        "subsectors": ["신약", "CDMO", "바이오시밀러", "진단", "의료기기", "임상", "기술수출"],
        "keywords": ["바이오", "제약", "임상", "FDA", "기술수출", "CDMO", "바이오시밀러", "신약", "허가", "진단"],
        "beneficiary_groups": ["신약 개발", "CDMO", "바이오시밀러", "의료기기", "진단"],
        "risks": ["임상 실패", "허가 지연", "자금 조달 부담", "기술수출 기대 선반영"],
        "watch_points": ["임상 결과", "FDA/EMA 허가", "기술수출 계약", "현금 소진 속도"],
    },
}
